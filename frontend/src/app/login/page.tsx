  ...
  return (
    <div className="grid min-h-dvh place-items-center px-4">
      <div className="w-full max-w-sm text-center">
        ...
        {erro && (
          <p className="mt-4 rounded border border-down/40 bg-down/5 p-3 text-[12px] text-body">
        ...
        <Link
          ...
          className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded border border-line-strong bg-raised px-4 py-2.5 text-[13px] text-body hover:border-warn"
        >
          Entrar com Discord
        </Link>
