...
export function CopyButton({
  ...
  if (indisponivel) {
    return (
      <span
        ...
        className={`shrink-0 cursor-not-allowed px-[2px] text-[11px] leading-none text-line-strong ${className}`}
      >
        ⧉
      </span>
    );
  ...
  return (
    <button
      ...
      className={`shrink-0 cursor-pointer border-0 bg-transparent px-[2px] text-[11px] leading-none transition-colors ${
